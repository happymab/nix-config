{ self, inputs, ... }: {
  ...
  flake.nixosModules.pantherConfiguration =
    {
      pkgs,
      lib,
      disko,
    ...
    }:
    {
      ...
      disko.devices.disk.main.device =
        "/dev/disk/by-id/ata-INTEL_SSDSCKJF180A5_SATA_180GB_CVTQ6176031L180A"; # External SSD 180GB for testing
      ...
      # Set git author and committer information for the automatic upgrade service
      systemd.services.nixos-upgrade.environment = {
        GIT_AUTHOR_NAME = "NixOS Auto-upgrade";
        GIT_AUTHOR_EMAIL = "root@&lt;panther&gt;";
        GIT_COMMITTER_NAME = "NixOS Auto-upgrade";
        GIT_COMMITTER_EMAIL = "root@&lt;panther&gt;";
      };
